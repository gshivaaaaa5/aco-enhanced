...
enum MessageType
{
    ACOTYPE_RREQ = 1,    //!< ACOTYPE_RREQ
    ACOTYPE_RREP = 2,    //!< ACOTYPE_RREP
    ACOTYPE_RERR = 3,    //!< ACOTYPE_RERR
    ACOTYPE_RREP_ACK = 4 //!< ACOTYPE_RREP_ACK
};
...
class TypeHeader : public Header
{
  public:
    /**
     * constructor
     * @param t the ACO RREQ type
     */
    TypeHeader(MessageType t = ACOTYPE_RREQ);
