 ...
 * @ingroup aco
 *
 * @brief ACO loopback UDP echo test case
 */
 ...
 * @ingroup aco-test
 *
 * @brief ACO Loopback test suite
 */
class AcoLoopbackTestSuite : public TestSuite
{
  public:
    AcoLoopbackTestSuite()
        : TestSuite("routing-aco-loopback", Type::SYSTEM)
    {
        SetDataDir(NS_TEST_SOURCEDIR);
        // UDP Echo loopback test case
        AddTestCase(new LoopbackTestCase(), TestCase::Duration::QUICK);
    }
} g_acoLoopbackTestSuite; ///< the test suite
